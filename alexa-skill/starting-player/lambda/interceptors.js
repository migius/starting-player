...
const SaveAttributesResponseInterceptor = {
    async process(handlerInput, response) {
        ...
        if ((shouldEndSession || Alexa.getRequestType(requestEnvelope) === 'SessionEndedRequest') && loadedThisSession) { // skill was stopped or timed out
            ...
            sessionAttributes['sC'] = sessionAttributes['sC'] ? sessionAttributes['sC'] + 1 : 1;
    ...
    async process(handlerInput) {
        ...
        if (!sessionAttributes['name']){
            ...
            try {
                ...
                console.log("requestEnvelope.context.System.user: " + requestEnvelope.context.System.user);
                ...
                if (profileName) { // the user might not have set the name
                    ...
                    console.log("profileName added to session: " + JSON.stringify(sessionAttributes));
                }
            } catch (error) {
